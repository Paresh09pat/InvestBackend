...
const { register, login, profile, updateProfile, logout, uploadProfilePictureController, deleteProfilePictureController, getPortfolio, getMyReferralTransactions, getReferralStats } = require("../controller/auth-controller");
...
router.get("/referral-transactions", getMyReferralTransactions);
